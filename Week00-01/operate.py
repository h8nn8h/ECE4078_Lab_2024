    ...
    def update_keyboard(self):
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN and event.key == pygame.K_UP:
                self.command['motion'] = [-5, 0] # replace with your code to make the robot drive forward
            # drive backward
            elif event.type == pygame.KEYDOWN and event.key == pygame.K_DOWN:
                self.command['motion'] = [5, 0] # replace with your code to make the robot drive backward
            # turn left
